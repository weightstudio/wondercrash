(function () {
  ...
  const dictionaries = {
    ...
    "zh-Hant": {
      ...
      "daily.title": "七日登入禮物",
      "daily.desc": "連續第 {count} 天。今天是第 {day} 天：可領 {diamonds} 顆鑽石。",
      "daily.day": "第 {day} 天",
      "daily.done": "已領",
      "daily.next": "下一天",
      "daily.claim": "領取",
      ...
      "status.favorite_games": "{count} 個最愛遊戲",
      "status.favorite_games_one": "1 個最愛遊戲",
      "status.no_favorites": "還沒有加入我的最愛。",
      "status.no_recent": "還沒有最近遊玩的遊戲。",
      "status.no_games": "目前沒有符合篩選的遊戲。",
      "status.recent_games_one": "1 款最近遊玩的遊戲",
      "status.recent_games": "{count} 款最近遊玩的遊戲",
