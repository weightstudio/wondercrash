  ...
  const localizedGames = {
    "zh-Hant": {
      ...
      "fruit-merge": {
        ...
        difficulty: "中等",
        time: "3-5 分鐘",
        intro: "動物合成塔是一款輕鬆但很有挑戰性的物理合成益智遊戲。玩家要把動物球放進箱子裡，讓相同動物碰撞後合成下一種更大的動物，從小老鼠一路挑戰合成到獅王球。每一次放下的位置都會影響動物球堆的平衡、滾動與後續空間，所以遊戲看起來簡單，實際上需要觀察、預測與一點耐心。它適合親子一起討論要放在哪裡，也適合喜歡刷新最佳紀錄的玩家短時間反覆挑戰。",
        how: ["左右移動準備中的動物球。", "選好位置後放下動物球。", "讓相同動物碰在一起，合成下一種更大的動物。", "保持動物球堆低於警戒線，挑戰更高分數與最佳紀錄。"],
        parent: "這款遊戲可以透過簡單的放置與合成練習空間判斷、邏輯思考、問題解決與手眼協調。分數只用於本機最佳紀錄與遊戲樂趣，不代表智力、學習能力或任何正式評量。",
        faq: [["動物合成塔適合幾歲？", "建議 5+，也適合親子一起玩。年紀較小的孩子可以由家長協助判斷放置位置。"], ["遊戲目標是什麼？", "盡量合成更大的動物球，讓動物球堆不要超過警戒線，並挑戰最高分。"], ["有時間限制嗎？", "沒有。玩家可以慢慢想好位置再放下。"], ["可以練習什麼能力？", "可以練習空間觀察、問題解決、邏輯判斷與手眼協調。"]],
      },
      "animal-hidden-safari": {
        title: "動物探險找找看",
        difficulty: "簡單",
      ...
      "zoo-helper-day": {
        ...
        difficulty: "簡單",
        time: "1-3 分鐘",
        intro: "動物園幫忙日是 WeightPlay 的幼兒動物照顧遊戲。孩子要觀察動物目前需要什麼，再選擇食物、水、清潔或陪玩道具。每一關都用清楚圖片、大按鈕和溫和回饋呈現，讓孩子不用大量閱讀也能理解目標。這款遊戲適合家長陪孩子短時間一起玩，一邊說出動物名稱，一邊討論牠可能需要什麼幫助。",
        how: ["觀察動物和圖片提示。", "選擇符合需求的幫忙道具。", "點擊或拖曳道具給動物。", "完成照顧任務後，解鎖下一個動物園小情境。"],
        strategyTips: ["先和孩子一起說出動物名稱。", "問孩子牠可能需要食物、水、清潔，還是陪牠玩。", "如果選錯，不要急著糾正，可以再看一次圖片提示並嘗試其他道具。"],
        parent: "這款遊戲可以讓孩子透過圖片互動練習動物辨識、簡單照顧概念、專注力與手眼協調。它適合當成短時間親子共玩活動，家長可以把每次選擇變成一句簡單對話。星星和進度只用於鼓勵與本機紀錄，不是診斷、排名或正式教育評量。",
        faq: [["3 歲可以玩嗎？", "可以。遊戲以圖片和大按鈕為主，家長陪同時會更容易理解，也更適合親子互動。"], ["可以練習什麼？", "可以練習動物辨識、專注力、手眼協調，以及餵食、喝水、清潔、陪伴等簡單照顧概念。"], ["需要會看字嗎？", "不需要。主要玩法靠圖片提示與道具圖示。"], ["需要登入嗎？", "不需要。基本遊玩不需要提供兒童個人資料。"]],
      },
      "shape-train": {
        title: "動物形狀小火車",
        difficulty: "簡單",
