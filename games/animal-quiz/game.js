...
dictionary["zh-Hant"] = {
  ...
  memory: "記憶",
  reading: "閱讀",
  reportGreat: "很棒！你很會觀察動物特徵，也能好好運用提示。",
  reportGood: "表現不錯！再玩一次可以更熟悉不同動物的特徵。",
  reportTry: "很好的練習！慢慢看圖片和提示，再試一次會更進步。",
  stageAfrica: "第 1 關：非洲動物",
  stageAsia: "第 2 關：亞洲動物",
  ...
  stageForest: "第 4 關：森林朋友",
  stageFarm: "第 5 關：農場與夜行動物",
  stageAfricaDesc: "認識草原、河流和溫暖棲地中的動物。",
  stageAsiaDesc: "猜猜森林、山區和身邊自然環境中的動物。",
  stageOceanHomeDesc: "找出海洋動物，以及孩子常見的動物。",
  stageForestDesc: "練習森林、竹林、池塘和樹上的動物。",
  stageFarmDesc: "複習熟悉的農場動物和夜晚活動的動物。",
  lion: "獅子",
  hippo: "河馬",
  snake: "蛇",
  rabbit: "兔子",
  ...
  cow: "牛",
  clueLion: "我有一圈很大的鬃毛。",
  clueHippo: "我喜歡水，而且嘴巴很大。",
  clueSnake: "我會在地上彎彎曲曲地爬行。",
  clueRabbit: "我有長耳朵，會跳來跳去。",
  clueTurtle: "我背上有硬硬的殼。",
  clueElephant: "我有一條很長的鼻子。",
  cluePenguin: "我是不太會飛、走路搖搖擺擺的鳥。",
  clueMonkey: "我會爬樹，也會盪來盪去。",
  clueBear: "我很大、毛茸茸，而且力氣很強。",
  clueCat: "我會喵喵叫，臉上有鬍鬚。",
  clueDog: "我會汪汪叫，也會搖尾巴。",
  clueFox: "我有橘色毛和蓬鬆的尾巴。",
  clueGiraffe: "我的脖子非常長。",
  clueZebra: "我身上有黑白條紋。",
  cluePanda: "我是黑白色的，也喜歡吃竹子。",
  clueKoala: "我喜歡抱著樹，耳朵圓圓的。",
  clueFrog: "我會跳，也會呱呱叫。",
  clueWhale: "我是生活在海洋裡的大型動物。",
  clueOwl: "我是有大眼睛的夜行鳥類。",
  clueCow: "我會哞哞叫，也能產牛奶。",
};
